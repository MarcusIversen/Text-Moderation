      ...
      <ThemeProvider theme={defaultTheme}>
        <Container component="main" style={{overflow: "hidden"}}>
          ...
          <Box className={"containerBox"}>
            ...
            <Typography variant="body1" className={"heading"}>We are sorry but the page you are looking for does not exist.</Typography>
            <Button variant="contained" color="secondary" className={"button"} onClick={handleBackHome}>
              Go Back
            </Button>
          </Box>
        </Container>

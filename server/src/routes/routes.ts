...
//AI Routes
router.post('/api/distilbert', modelEndpoint('https://api-inference.huggingface.co/models/distilbert-base-uncased-finetuned-sst-2-english'));
router.post('/api/nsfw', modelEndpoint('https://api-inference.huggingface.co/models/michellejieli/inappropriate_text_classifier'));
router.post('/api/moderation', modelEndpoint('https://api-inference.huggingface.co/models/KoalaAI/Text-Moderation'));
router.post('/api/contactInfo', modelEndpoint('https://api-inference.huggingface.co/models/jakariamd/opp_115_privacy_contact_information'));
